...
export default function PostCard(props) {
  ...
  const onExpandButtonClicked = () => {
    ...
    if (replyingToThisPost) replyingToDispatch({ type: "set", payload: null });
  };
  ...
  const onReplyButtonClicked = () => {
    ...
    if (!thisPostExpanded) expandedDispatch({ type: "add", payload: post_id });
  };
    ...
    <>
      <Card className={classes.root}>
        ...
        <CardActions className={classes.actionArea}>
          {/* Reply button */}
          <Button
            disabled={!nearEnoughToReply || !isLoggedIn}
