...
const Register = (props) => {
    ...
    const onSubmit = () => {
        if (!username || !password || !confirmPassword) {
            ...
            // if successfull redirects to login page
            }).then(updatedState => {
                openSnackbar('Registration successfull. You may now login.', 'success');
    ...
    return (
        <Grid container spacing={1} direction='column' alignItems='center' justify='flex-start' className={classes.gridContainer}>
            ...
            {error !== '' &&
                <Grid item>
                    <Typography className={error ? classes.errorText : null}>{message}</Typography>
                </Grid>
            }
