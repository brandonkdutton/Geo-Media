                    ...
                    {props.doneFetchingUserData ?
                        (currentUserState.isLoggedIn ? (
                                ...
                                <Grid container direction={'row'} justify={'center'} alignItems={'center'} spacing={4}>
                                    <Grid item>
                                        <Button variant='outlined' onClick={handleLogout} className={classes.enablePointerEvents}>Logout</Button>
                                    </Grid>
                            ...
                            <Grid container justify={'center'} alignItems="center" spacing={4} style={{marginRight: '25px'}}>
                                <Grid item>
                                    <Button variant='outlined' onClick={() => history.push('/login')} className={classes.enablePointerEvents}>Login</Button>
                                </Grid>
                                <Grid item>
                                    <Button variant='outlined' onClick={() => history.push('/register')} className={classes.enablePointerEvents}>Register</Button>
                                </Grid>
                            </Grid>
                        )) : (
                            <CircularProgress/>
